...
(async () => {
  ...
  await fs.writeFile("carcinoma-in-situ_cervical-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("carcinoma-in-situ_cervical-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
